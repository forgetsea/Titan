...
public class TicketMasterAPI {
	...
	private static final String DEFAULT_TERM = ""; //no restrction
	private static final String API_KEY = "MmsJI1CCLlLe57l5e73uINuFV5AqNTBK";
			...
			for (int i = 0; i < classification.length(); i++) {
				...
				if (!obj.isNull("segment")) {
					...
					if (!segment.isNull("name")) {
						category.add(segment.getString("name"));
					}
				}
			}
			return category;
